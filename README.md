...
Installation: Very simple, copy the following files from the zip folder in to the source directory of your project and #include "CBMDisk.h". That's it and your ready to rock and roll!
...
CBMData *data;			                      // This data type is used to store data loaded from disk such as 
				                                  ...
				                                  // It has to 2 important structure variables array and size, the array is a 				                           	                                         // byte * pointer (unsigned char) and it is used to point to your data 						                        
